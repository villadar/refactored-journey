...
import ca.humanheartnature.abstracts.comm.DataConnectionFactory;
 ...
 */
public class QboDataConnectionFactory implements DataConnectionFactory
{
    ...
    * @throws FMSException 
    */
   public QboDataConnectionFactory(String baseUrl,
                                  String appToken,
                                  String realmId,
                                  String consumerKey,
   ...
   @Override
   public DataService getConnection() 
   {
      return dataService;
   }
